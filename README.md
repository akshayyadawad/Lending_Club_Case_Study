...
![image](https://github.com/akshayyadawad/Lending_Club_Case_Study/assets/83698856/b23bd5f1-d8d6-42f9-9282-536ace7d3a83)
...
# Project Name
Identify patterns which indicate if a person is likely to default, while taking loans Identify risky loan applicants using EDA, and such loans can be reduced thereby cutting down the amount of credit loss.
...
## General Information
- Background: The aim is to identify patterns which indicate if a person is likely to default, which may be used for taking actions such as denying the loan, reducing the amount of loan, lending (to risky applicants) at a higher interest rate, etc. 
